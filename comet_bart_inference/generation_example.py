...
physical_entity = ["ObjectUse", "AtLocation", "MadeUpOf", "HasProperty", "CapableOf", "Desires", "NotDesires"]
...
if __name__ == "__main__":
    ...
    for query, tails in zip(queries, results):
        for tail in tails:
            print(query[:-5] + tail)
